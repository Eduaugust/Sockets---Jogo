...
class ServerProjetil:
    def __init__(self, userId: str, userName: str, x: int, y: int, moveX: int, moveY: int, team: str, radius: int = 10, timeToDestroy: int = 500, atualTimeToDestroy: int = 0, damage: int = 1) -> None:
        self.id = str(uuid.uuid4())
        self.userId = userId
        self.userName = userName
        self.x = x
